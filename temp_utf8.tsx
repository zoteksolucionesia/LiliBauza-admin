...
export default function DocumentosPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: colors.background }}>
      ...
      <Header
        title="Documentos"
        subtitle="Constancias, recetas y diagn├│sticos"
      />
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            >
              ...
              <p className="text-xs" style={{ color: colors.textMuted }}>De participaci├│n o laboral</p>
            </button>
            <button
              onClick={() => {
            ...
            >
              ...
              <p className="text-xs" style={{ color: colors.textMuted }}>M├®dica psicol├│gica</p>
            </button>
            <button
              onClick={() => {
            ...
            >
              ...
              <p className="font-medium" style={{ color: colors.text }}>Diagn├│stico</p>
              <p className="text-xs" style={{ color: colors.textMuted }}>Evaluaci├│n psicol├│gica</p>
            </button>
          </div>
      ...
      <ConfirmModal
        ...
        message={`┬┐Est├ís seguro de que deseas eliminar "${selectedDoc?.titulo}"? Esta acci├│n no se puede deshacer.`}
...
function DocumentoForm({ tipo, pacientes, onClose }: DocumentoFormProps) {
  ...
  const getTemplate = () => {
    ...
    if (tipo === "constancia") {
      return `CONSTANCIA DE PARTICIPACI├ôN

Por medio de la presente, la Mtra. Liliana Bauza, psic├│loga cl├¡nica certificada, hace CONSTAR QUE:

${paciente?.nombre_completo || "[NOMBRE DEL PACIENTE]"}

Ha participado en sesiones de terapia psicol├│gica en mi consultorio particular.

Esta constancia se expide a petici├│n del interesado para los fines legales que le convengan.

Ciudad de M├®xico, a ${fecha}.
...
INDICACIONES TERAP├ëUTICAS:

1. Continuar con sesiones de terapia psicol├│gica

2. [INDICACIONES ESPEC├ìFICAS]
...
Mtra. Liliana Bauza`;
    ...
    if (tipo === "diagnostico") {
      return `INFORME DE EVALUACI├ôN PSICOL├ôGICA
